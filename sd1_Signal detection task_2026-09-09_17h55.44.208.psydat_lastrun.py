...
expName = 'sd1_Signal detection task_2026-09-09_17h55.44.208.psydat'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/anayatalesra/Desktop/psy310/signal detection/sd1_Signal detection task_2026-09-09_17h55.44.208.psydat_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Welcome to the experiment\nPress ‘up’ if the lines are verticle and ‘down’ if you see a tilt. \nPress ‘space’ to start',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    key_resp_2 = keyboard.Keyboard(deviceName='defaultKeyboard', backend='PsychToolbox')
